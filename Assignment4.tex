...
\author{\sf\Large\textbf{ Lulu Pi}\\ {\sf\large XXX\\[0.5cm]} \sf\Large\textbf{ Emily Sheehan}\\ {\sf\large BCom\\[0.5cm]} \sf\Large\textbf{ Brenwin Ang}\\ {\sf\large BsC\\[0.5cm]} \sf\Large\textbf{ Chengzhi Ye}\\ {\sf\large XXX\\[0.5cm]}}
...
To create Figure \ref{fig:TypeOfResistance} the use of force data was filtered for type of resistance. The results were plotted. Each resistance band was filled according to Precinct.
...
To create Figure \ref{fig:Race} the use of force data was filtered for race. The results were plotted and each force type band was filled according to race.
...
The last Figure \ref{fig:Race} shows the use of force on different races. African Americans are subject to more aggressive forms of force. Further, the figure demonstrates police are less likely to use less lethal force on African Americans. Looking at this figure alone, it is likely the treatment of African Americans is too violent.
...
\hypertarget{use-of-force-map-analysis}{%
\subsection{Use of Force Map Analysis}\label{use-of-force-map-analysis}}
