...
The crime incident data was wrangled, and each offense was assigned to its relevant offense type. Each offense was grouped according to year, and the incidence of each offense was calculated. The results were plotted.
...
\caption{The average crimes and force used in a week}\label{fig:weekdaysituation}
\end{figure}

The last three figures are made by ggplot2 package and scales package, to make the exploratory analysis in force using by police and show the figures more clearly. Figure \ref{fig:TypeOfResistance} shows the resistance used in each precinct. In essence, this figure captures the prevalance of crime and perhaps the effiency of police in controlling the crime rate. It can be inferred that the fourth precinct is significantly more dangerous than the fifth precinct, and the force use in the fourth precinct is much higher.
...
The last Figure \ref{fig:Race} shows the proportion of different Race in the use of force. It is clear that African Americans are subject to more aggressive forms of force, which accounts for 70\% in most force using ways. Further, the figure demonstrates police are less likely to use less lethal force on African Americans. Only from this figure alone, we may have a question, Is the way the police treat black people too radical?
