...
# Mapping the data and Black composition
...
summary_table %>% 
  kable(caption = "Share of black in each category",
        digits = 2) %>% 
  kable_styling(bootstrap_options = c("striped", "hover"))
...
Black or African Americans accounts only for 19% of the total Population in Minneapolis. (Data source: @mncompass). However, as we can see from **table \@ref(tab:summarytable)**, they cover the largest proportion of being subjects to police use of force. Furthermore, they also cover the biggest share in terms of their vehicles getting stopped by the police. 

*Note that each share racial population share are subject to a 5% or less margin of error. 

## Police Use of force Data mapping
...
Similar to the analysis with the police use of force map, a similar pattern were  observed in police stop in **Figure \@ref(fig:psmap)**. Police stops are mostly concentrated in the northwestern and central parts of Minneapolis where black communities are highly represented.
