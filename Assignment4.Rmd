...
## Analysis on neighborhoods with the most crimes

## Analysing the crime incident data 

## Analysing crime with time 
...
kable(number_crimes,
      ...
      caption = "The Incidence of Crime according to Year and Offense Type") %>%
  # Add kable styling options, position the table in the centre of the report
